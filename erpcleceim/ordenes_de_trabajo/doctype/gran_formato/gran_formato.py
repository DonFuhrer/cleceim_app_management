...
def get_default_item_type():
	item_type = frappe.db.get_single_value("Ajustes", "default_item_type_gf")
	return {"item_type": item_type}

@frappe.whitelist()
def get_default_stock_uom():
	stock_uom = frappe.db.get_single_value("Ajustes", "default_stock_uom")
	return {"stock_uom": stock_uom}

@frappe.whitelist()
def get_default_warehouse():
	wip_warehouse = frappe.db.get_single_value("Ajustes", "default_wip_warehouse")
	fg_warehouse = frappe.db.get_single_value("Ajustes", "default_fg_warehosue")
	return {"wip_warehouse": wip_warehouse, "fg_warehouse": fg_warehouse}
